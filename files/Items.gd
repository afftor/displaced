...
var Materials = {
	wood = {name = tr("MATERIALWOOD"), price = 1, icon = load("res://assets/images/gui/Wood.png"), description = tr('MATERIALDESCRIPTWOOD'),
	...
	elvenwood = {name = tr("MATERIALELVENWOOD"), price = 1, icon = null, description = tr('MATERIALDESCRIPTELVENWOOD'),
...
#	}},
	goblinmetal = {name = tr("MATERIALGOBLINMETAL"), price = 1, icon = null, description = tr('METARIALGOBLINGMETALDESCRIPT'),
	...
	elvenmetal = {name = tr("MATERIALELVENMETAL"), price = 1, icon = null, description = tr('METARIALELVENMETALDESCRIPT'),
	...
	leather = {name = tr("MATERIALLETHER"), price = 1, icon = load("res://assets/images/gui/Wood.png"), description = tr('MATERIALDESCRIPTLEATHER'),
	...
	bone = {name = tr("MATERIALBONE"), price = 1, icon = load("res://assets/images/gui/Wood.png"), description = tr('MATERIALDESCRIPTBONE'),
