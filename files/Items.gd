...
var Materials = {
	wood = {name = tr("MATERIALWOOD"), price = 1, icon = load("res://assets/images/icons/Wood.png"), description = tr('MATERIALDESCRIPTWOOD'),
	adjective = tr("WOODADJ"),
	DefaultEffect = 'natural',
	code = 'wood',
	unlockreq = true,
	color = Color8(139,87,42),
	parts = {
	}},
	elvenwood = {name = tr("MATERIALELVENWOOD"), price = 1, icon = load("res://assets/images/icons/ElvenWood.png"), description = tr('MATERIALDESCRIPTELVENWOOD'),
	adjective = tr("ELVENADJ"),
	DefaultEffect = '',
	code = 'elvenwood',
	unlockreq = true,
	color = Color8(162,205,90),
	parts = {
	}},
...
#	}},
	goblinmetal = {name = tr("MATERIALGOBLINMETAL"), price = 1, icon = load("res://assets/images/icons/GoblinMetal.png"), description = tr('METARIALGOBLINGMETALDESCRIPT'),
	...
	elvenmetal = {name = tr("MATERIALELVENMETAL"), price = 1, icon = load("res://assets/images/icons/ElvenMetal.png"), description = tr('METARIALELVENMETALDESCRIPT'),
	...
	leather = {name = tr("MATERIALLETHER"), price = 1, icon = load("res://assets/images/icons/Leather.png"), description = tr('MATERIALDESCRIPTLEATHER'),
	...
	bone = {name = tr("MATERIALBONE"), price = 1, icon = load("res://assets/images/icons/Bone.png"), description = tr('MATERIALDESCRIPTBONE'),
	...
	cloth = {name = tr("MATERIALCLOTH"), price = 1, icon = load("res://assets/images/gui/Wood.png"), description = tr('MATERIALDESCRIPTCLOTH'),
...
var Items = {
	...
	icon = load("res://assets/images/gui/axe.png"),
	basedurability = 50.0,
	basestats = {damage = 20},
	basemods = {},
	itemtype = 'weapon',
	...
	icon = load("res://assets/images/gui/axe.jpg"),
	itemtype = 'usable',
	unlockreq = true,
	useeffects = ['heal50'],
	useskill = 'steakheal',
