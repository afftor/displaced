...
func rebuild():
	if pressed:
		...
		$Label2.set("custom_colors/font_color", variables.hexcolordict.highlight_blue)
	elif over:
		$Label.set("custom_colors/font_color", variables.hexcolordict.light_grey)
		$Label2.set("custom_colors/font_color", variables.hexcolordict.light_grey)
	else:
		$Label.set("custom_colors/font_color", variables.hexcolordict.dark_grey)
		$Label2.set("custom_colors/font_color", variables.hexcolordict.dark_grey)
