...
var TranslationDict = {
	...
	SKILLSOUL_BEAMDESCRIPT = "Dispell all target barriers. Consume all spirits. Deal damage based on spirits consumed. After damage apply debuff: Increase incoming damage by 20% for 2 turns.",
