...
#	},
	...
	lunge = {
		...
		reqs = [],
		tags = ['damage'],
		value = [['caster.damage', '*0.4'], ['caster.damage', '*1.2']],
...
#	},
	...
	fire_bolt = {
		...
		reqs = [],
		tags = ['damage'],
		value = [['caster.damage', '*0.35'], ['caster.damage']],
		damagestat = ['no_stat', '+damage_hp'],
		cooldown = 0,
...
#			{conditions = [{type = 'gear_level', slot = 'weapon1', level = 2, op = 'gte'}], patch = 'p_thorn'},
	...
	purge = {
		...
		tags = ['debuff', 'dispel'],
		value = ['0'],
		damagestat = ['damagehp'],#is it legitimate damagestat?
		cooldown = 0,#10,
		casteffects = [
	...
	vic_fburst = {
		...
		value = [['caster.damage', '*0.4'],['caster.damage', '*0.35']],
		damagestat = ['no_stat', '+damage_hp'],
		cooldown = 2,
...
#			{code = 'sfx_explosion', target = 'target_group', period = 'predamage'}
	...
	fire_breath = {
		...
		value = [['caster.damage'], ['caster.damage', '*0.35']], 
		damagestat = ['no_stat', '+damage_hp'],
		cooldown = 2, 
...
#	},
	...
	item_heal_aoe_3_effect = {
		...
		reqs = [],
		tags = ['heal'],
		value = [['target.hpmax'], ['100']],
		damagestat = ['-damage_hp', '=ultimeter'],
		cooldown = 0,
		casteffects = [],
		repeat = 1,
		hidden = false,
