...
#		manacost = 0,
		...
		ai_priority = 1,
		sounddata = {initiate = null, strike = null, hit = 'sound_hit', hittype = 'absolute'},
	},
	defence = {
		code = 'defence',
		name = "",
...
#		manacost = 0,
		casteffects = [],
		hidden = false,
		sfx = [{code = 'sfx_earthquake', target = 'target_group', period = 'windup'}, #it's better to make a separate earthquake animation to set up custom delay
			{code = 'anim_hit', target = 'target', period = 'predamage'},],
		sfxcaster = null,
		sfxtarget = null,
		sounddata = {initiate = 'firebolt', strike = null, hit = 'firehit', hittype = 'absolute'},
