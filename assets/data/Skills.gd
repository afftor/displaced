...
#		manacost = 0,
		...
		sfx = [{code = 'anim_cast', target = 'caster', period = 'predamage'},
			{code = 'anim_hit', target = 'target', period = 'predamage'},
			{code = 'sfxFlipH_firepunch', target = 'target', period = 'predamage'}],
		sfxcaster = null,
		sfxtarget = null,
		patches = [],
		ai_priority = 1
...
#		manacost = 0,
	...
	earth_attack = {
		...
		repeat = 1,
		hidden = false,
		sfx = [{code = 'sfxFlipH_earth_strike', target = 'target', period = 'predamage'},
			{code = 'anim_hit', target = 'target', period = 'predamage'},
	...
	air_attack = {
		...
		repeat = 1,
		hidden = false,
		sfx = [{code = 'sfxFlipH_gustofwind', target = 'target', period = 'predamage'},
			{code = 'anim_hit', target = 'target', period = 'predamage'},
			{code = 'anim_attack', target = 'caster', period = 'windup'}],
		sfxcaster = null,
		sfxtarget = null,
	...
	dark_attack = {
		...
		repeat = 1,
		hidden = false,
		sfx = [{code = 'sfxFlipH_dark_orb', target = 'target', period = 'predamage'},
			{code = 'anim_hit', target = 'target', period = 'predamage'},
			{code = 'anim_attack', target = 'caster', period = 'windup'}],
		sfxcaster = null,
		sfxtarget = null,
	...
	light_attack = {
		...
		repeat = 1,
		hidden = false,
		sfx = [{code = 'sfxFlipH_holy_light', target = 'target', period = 'predamage'},
			{code = 'anim_hit', target = 'target', period = 'predamage'},
			{code = 'anim_attack', target = 'caster', period = 'windup'}],
		sfxcaster = null,
		sfxtarget = null,
	...
	pierce_attack = {
		...
		sfx = [{code = 'anim_attack', target = 'caster', period = 'predamage'},
			{code = 'anim_hit', target = 'target', period = 'predamage'},
			{code = 'sfxFlipH_lunge', target = 'target', period = 'predamage'}],
		sfxcaster = null,
		sfxtarget = null,
		patches = [],
		ai_priority = 1
...
#		manacost = 0,
		...
		sfx = [{code = 'anim_attack', target = 'caster', period = 'predamage'},
			{code = 'anim_hit', target = 'target', period = 'predamage'},
			{code = 'sfx_termination', target = 'target', period = 'predamage'}],
		sfxcaster = null,
		sfxtarget = null,
		patches = [
...
#		manacost = 0,
		...
		sfx = [{code = 'anim_attack', target = 'caster', period = 'windup'},
			{code = 'anim_hit', target = 'target', period = 'predamage'},
			{code = 'sfx_deluge', target = 'target', period = 'predamage'}],
		sfxcaster = null,
		sfxtarget = null,
		sounddata = {initiate = 'firebolt', strike = null, hit = 'firehit', hittype = 'absolute'},
		patches = [
...
#		manacost = 0,
		...
		repeat = 1,
		hidden = false,
		sfx = [{code = 'sfxFlipH_soul_prot', target = 'target', period = 'predamage'},
			{code = 'anim_attack', target = 'caster', period = 'windup'},],
		sfxcaster = null,
		sfxtarget = null,
		patches = [],
...
#		manacost = 0,
		...
		{code = 'sfxFlipH_soul_prot', target = 'target', period = 'predamage'},
		{code = 'anim_attack', target = 'caster', period = 'windup'}],
		sfxcaster = null,
		sfxtarget = null,
		patches = [],
...
#		manacost = 0,
		...
		sfx = [{code = 'anim_attack', target = 'caster', period = 'predamage'},
			{code = 'anim_hit', target = 'target', period = 'predamage'},
			{code = 'sfxFlipH_poison_spit', target = 'target', period = 'predamage'}],
		sfxcaster = null,
		sfxtarget = null,
		patches = [],
		ai_priority = 1
...
#		manacost = 0,
		...
		repeat = 1,
		hidden = false,
		sfx = [{code = 'sfxFlipH_pale_mist', target = 'target', period = 'predamage'},
			{code = 'anim_hit', target = 'target', period = 'postdamage'},
			{code = 'anim_attack', target = 'caster', period = 'windup'},],
		sfxcaster = null,
		sfxtarget = null,
...
#		manacost = 0,
		...
		sfx = [{code = 'anim_attack', target = 'caster', period = 'windup'},
			{code = 'anim_hit', target = 'target', period = 'predamage'},
			{code = 'sfxFlipH_roar', target = 'target', period = 'predamage'}
			],
		sfxcaster = null,
		sfxtarget = null,
		patches = [],
...
#		manacost = 0,
		...
		sfx = [{code = 'anim_attack', target = 'caster', period = 'predamage'},
			{code = 'anim_hit', target = 'target', period = 'predamage'},
			{code = 'sfxFlipH_tail_swipe', target = 'target', period = 'predamage'}],
		sfxcaster = null,
		sfxtarget = null,
		patches = [],
		ai_priority = 1
...
#		manacost = 0,
		...
		sfx = [{code = 'anim_attack', target = 'caster', period = 'windup'},
			{code = 'anim_hit', target = 'target', period = 'predamage'},
			{code = 'sfxFlipH_deluge', target = 'target', period = 'predamage'}],
		sfxcaster = null,
		sfxtarget = null,
		patches = [],
		ai_priority = 1
...
#		manacost = 0,
		...
		sfx = [{code = 'anim_attack', target = 'caster', period = 'windup'},
			{code = 'anim_hit', target = 'target', period = 'predamage'},
			{code = 'sfxFlipH_heavystrike', target = 'target', period = 'predamage'}],
		sfxcaster = null,
		sfxtarget = null,
		patches = [],
		ai_priority = 1
...
#		manacost = 0,
		...
		sfx = [{code = 'anim_attack', target = 'caster', period = 'windup'},
			{code = 'anim_hit', target = 'target', period = 'predamage'},
			{code = 'sfxFlipH_impale', target = 'target', period = 'predamage'}],
		sfxcaster = null,
		sfxtarget = null,
		patches = [],
		ai_priority = 1 #?
