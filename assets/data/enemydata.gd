...
var enemylist = {
	elvenrat = {
		...
		basehp = 130,
		damage = 25,
		resists = {slash = -50, earth = 50, water = -100, light = -100, dark = 50},
		xpreward = 10,
...
#		bodyimage = null,
	...
	mole = { 
		...
		basehp = 130,
		damage = 30,
		resists = {slash = -50, bludgeon = 50, fire = 50, water = -100, light = -100, dark = -50},
		xpreward = 10,
		base_dmg_type = 'pierce',
		traits = [],
...
#		bodyimage = null,
	...
	vulture = { 
		...
		basehp = 124,
		damage = 56,
		resists = {slash = 50, pierce = -50, bludgeon = 50, earth = 50, water = -50, light = -50},
		xpreward = 10,
		base_dmg_type = 'pierce',
		traits = [],
...
#		bodyimage = null,
	...
	faery = {
		...
		basehp = 86,
		damage = 35,
		resists = {pierce = -100, bludgeon = 50, air = 100, fire = 50, earth = 50, water = -100, light = -100},
		xpreward = 10,
		base_dmg_type = 'air',
		traits = [],
...
#		bodyimage = null,
	...
	faery_2 = {
		...
		basehp = 55,
		damage = 61,
		resists = {pierce = -100, bludgeon = 50, fire = -50,  earth = 50, water = -100, dark = -100},
		xpreward = 10,
		base_dmg_type = 'air',
		traits = [],
...
#		bodyimage = null,
	...
	spider = {
		...
		basehp = 90,
		damage = 45,
		resists = {slash = -50, pierce = 50, fire = 50, air = -50, dark = 50},
		xpreward = 10,
		base_dmg_type = 'pierce',
		traits = [],
...
#		bodyimage = null,
	...
	spider_2 = {
		...
		basehp = 75,
		damage = 55,
		resists = {slash = -50, pierce = 50, fire = 50, air = -50, light = 50},
		xpreward = 10,
		base_dmg_type = 'pierce',
		traits = [],
...
#		bodyimage = null,
	...
	earthgolem = {
		...
		basehp = 160,
		damage = 37,
		resists = {slash = 100, pierce = 50, bludgeon = -100, earth = 150, water = -100},
		xpreward = 10,
		base_dmg_type = 'earth',
		traits = [],
...
#		bodyimage = null,
	...
	angrydwarf = {
		...
		basehp = 152,
		damage = 51,
		resists = {slash = 50, bludgeon = 50, fire = -50, air = -50, earth = 50, water = -100, dark = -100},
		xpreward = 10,
		base_dmg_type = 'slash',
		traits = ['dw_enrage'],
...
#		bodyimage = null,
	...
	dwarfwarrior = {
		...
		basehp = 184,
		damage = 37,
		resists = {slash = -50, pierce = 50, fire = 100, bludgeon = -50, earth = 100, water = -50, air = -50, light = -100},
		xpreward = 10,
		base_dmg_type = 'slash',
		traits = ['dw_enrage'],
...
#		bodyimage = null,
	...
	zombie = {
		...
		basehp = 142,
		damage = 40,
		resists = {slash = 100, fire = -100, earth = 50, water = 100, light = -100},
		xpreward = 10,
		base_dmg_type = 'bludgeon',
		traits = [],
...
#		bodyimage = null,
	...
	skeleton_warrior = {
		...
		basehp = 132,
		damage = 45,
		resists = {pierce = 100, bludgeon = -50, fire = 50, earth = -50, water = -50, air = -50, light = -50},
		xpreward = 10,
		base_dmg_type = 'slash',
		traits = ['wounds'],
...
#		bodyimage = null,
		...
		bodyhitsound = 'skeleton warrior hit',
		animations = {
	...
	skeleton_archer = {
		...
		basehp = 117,
		damage = 62,
		resists = {pierce = 100, bludgeon = -100, fire = 50, earth = -50, water = -50, air = -50, light = -50},
		xpreward = 10,
		base_dmg_type = 'pierce',
		base_dmg_range = 'any',
		traits = [],
...
#		bodyimage = null,
	...
	wraith = {
		...
		basehp = 98,
		damage = 65,
		resists = {slash = 100, pierce = 100, bludgeon = 100, fire = -100, water = -100, air = -100, light = -100},
		xpreward = 10,
		base_dmg_type = 'dark',
		traits = [],
...
#		bodyimage = null,
	...
	cult_soldier = {
		...
		basehp = 106,
		damage = 58,
		resists = {slash = 50, pierce = -50, fire = 50, earth = -50, light = -50},
		xpreward = 10,
		base_dmg_type = 'slash',
		traits = [],
...
#		bodyimage = null,
	...
	cult_mage = {
		...
		basehp = 90,
		damage = 65,
		resists = {slash = -50, bludgeon = 50, fire = 100, earth = -50, water = 50, air = -50, light = 50, dark = -50},
		xpreward = 10,
		base_dmg_type = 'air',
		base_dmg_range = 'any',
		traits = [],
...
#		bodyimage = null,
		...
		weaponsound = 'culthealer cast',
		bodyhitsound = 'culthealer hit',
		animations = {
	...
	cult_archer = {
		...
		basehp = 112,
		damage = 51,
		resists = {slash = 50, pierce = 50, fire = -50, earth = 50, air = 100, light = -50},
		xpreward = 10,
		base_dmg_type = 'pierce',
		base_dmg_range = 'any',
		traits = [],
...
#		bodyimage = null,
	...
	hatchling = {
		...
		basehp = 120,
		damage = 45,
		resists = {slash = -50, bludgeon = 50, fire = 100, earth = -50, water = -50, air = 50, light = -50},
		xpreward = 10,
		base_dmg_type = 'fire',
		traits = [],
...
#		bodyimage = null,
	...
	wyvern = {
		...
		basehp = 150,
		damage = 55,
		resists = {slash = 50, pierce = -50, bludgeon = 50, fire = 100, earth = 50, water = -50, air = -50, light = 50, dark = -100},
		xpreward = 10,
		base_dmg_type = 'pierce',
		traits = [],
...
#		bodyimage = null,
	...
	armored_beast = {
		...
		basehp = 180,
		damage = 44,
		resists = {pierce = 100, bludgeon = -100, fire = -100, earth = 100, water = -50, air = 50, light = -50, dark = 50},
		xpreward = 10,
		base_dmg_type = 'bludgeon',
		traits = [],
...
#		bodyimage = null,
	...
	giant_toad = {
		...
		basehp = 130,
		damage = 52,
		resists = {pierce = 50, bludgeon = -50, fire = 50, earth = -50, water = 100, air = -100, light = 50, dark = -50},
		xpreward = 10,
		base_dmg_type = 'water',
		traits = [],
...
#		bodyimage = null,
	...
	demon1 = {
		...
		basehp = 150,
		damage = 66,
		resists = {slash = 50, pierce = -100, bludgeon = 50, fire = 100, earth = 50, water = -50, air = -100, light = -100, dark = 50},
		xpreward = 10,
		base_dmg_type = 'slash',
		traits = [],
...
#		bodyimage = null,
	...
	soldier = {
		...
		flavor = "",
		race = 'humanoid',
		skills = ['attack', 'light_attack_soldier'],
		basehp = 180,
		damage = 70,
		resists = {slash = -50, pierce = 50, fire = 50, earth = -50, water = 100, air = 100, dark = -50},
		xpreward = 10,
		base_dmg_type = 'pierce',
		traits = [],
...
#		bodyimage = null,
	...
	drone = {
		...
		flavor = "",
		race = 'humanoid',
		skills = ['attack', 'light_attack_drone'],
		basehp = 210,
		damage = 60,
		resists = {slash = -50, bludgeon = 100, fire = -50, earth = 100, water = -50, air = -100, dark = 50},
		xpreward = 10,
		base_dmg_type = 'pierce',
		traits = [],
...
#		mdef = 0,
		...
		damage = 73,
#		speed = 20,
		resists = {fire = -50, pierce = 50, water = 100},
...
#		mdef = 15,
		...
		damage = 100,
#		speed = 30,
		resists = {slash = 50, pierce = 80, bludgeon = -50, earth = 150, water = -50, air = 50, light = 50, dark = -50},
		status_resists = {stun = 100},
		xpreward = 50,
		is_boss = true,
		combaticon = 'enemies/EarthgolemCombatIcon',
#		bodyimage = null,
	...
	dwarvenking = {
		...
		flavor = "",
		race = 'rock',
		skills = ['attack', 'dk_stun', 'dk_slash', 'dk_strike'],
#		passives = [],
...
#		bodyimage = null,
	...
	dwarvenking_2 = {
		code = '',
		name = "MONSTERDWARVENKING",
		flavor = "MONSTERDWARVENKINGFLAVOR",
		race = 'rock',
		skills = ['attack', 'dk_stun', 'dk_dark', 'dk_execute_charge'],
		traits = ['dwking_enrage2'],
		basehp = 430,
		evasion = 0,
		hitrate = 95,
		damage = 74,
...
#		mdef = 15,
		...
		damage = 90,
#		speed = 30,
		resists = {pierce = -50, bludgeon = 90, fire = 100, earth = 90, water = -50, light = -50},
		status_resists = {stun = 100},
		xpreward = 50,
...
#		mdef = 15,
		...
		damage = 70,
#		speed = 30,
		resists = {slash = 25, pierce = -50, fire = 100, earth = 100, water = -50, air = -50, light = 50, dark = -50},
		status_resists = {stun = 100},
		xpreward = 50,
		is_boss = true,
...
#		mdef = 15,
		...
		damage = 110,
#		speed = 30,
		resists = {slash = -50, pierce = 100, bludgeon = -50, fire = 100, earth = -50, water = 100, air = 80, light = -100, dark = 100},
		status_resists = {stun = 100},
		xpreward = 50,
		is_boss = true,
...
#		mdef = 15,
		...
		damage = 75,
#		speed = 30,
		resists = {slash = -50, pierce = 50, bludgeon = 50, light = -100, dark = 50, air = 50, water = -50, earth = 50, fire = 50},
		status_resists = {stun = 100},
		xpreward = 50,
		is_boss = true,
