...
var Items = {
	...
	#materials
	wood = {name = "MATERIALWOOD",
#	code = 'wood',#set in _ready()
	description = "MATERIALWOODDESCRIPT",
	icon = load("res://assets/images/iconsitems/Wood.png"),
	itemtype = 'material',
	useskill = '',
	price = 50,
	},
	stone = {name = "MATERIALSTONE",
#	code = 'stone',
	description = "MATERIALSTONEDESCRIPT",
	icon = load("res://assets/images/iconsitems/stone.png"),
	itemtype = 'material',
	useskill = '',
	price = 50,
	},
	metal = {name = "MATERIALMETAL",
#	code = 'metal',
	description = "MATERIALMETALDESCRIPT",
	icon = load("res://assets/images/iconsitems/DwarvenMetal.png"),
	itemtype = 'material',
	useskill = '',
	price = 50,
	},
	scales = {name = "MATERIALSCALES",
#	code = 'scales',
	description = "MATERIALSCALESDESCRIPT",
	icon = load("res://assets/images/iconsitems/scales.png"),
	itemtype = 'material',
	useskill = '',
	price = 50,
	},
	otherworld = {name = "MATERIALOTHERWORLD",
#	code = 'otherworld',
	description = "MATERIALOTHERWORLDDESCRIPT",
	icon = load("res://assets/images/iconsitems/otherworld.png"),
	itemtype = 'material',
	useskill = '',
	price = 50,
	},
	chitine = {name = "MATERIALCHITINE",
#	code = 'chitine',
	description = "MATERIALCHITINEDESCRIPT",
	icon = load("res://assets/images/iconsitems/chitin.png"),
	itemtype = 'material',
	useskill = '',
	price = 50,
	},
	leather = {name = "MATERIALLEATHER",
#	code = 'leather',
	description = "MATERIALLEATHERDESCRIPT",
	icon = load("res://assets/images/iconsitems/Leather.png"),
	itemtype = 'material',
	useskill = '',
	price = 50,
	},
	demonic = {name = "MATERIALDEMONIC",
#	code = 'demonic',
	description = "MATERIALDEMONICDESCRIPT",
...
#	},
	...
	item_heal_1 = {
		name = "ITEMITEM_HEAL_1NAME",
#		code = 'item_heal_1',
		description = "ITEMITEM_HEAL_1DESCRIPT",
	...
	item_heal_2 = {
		name = "ITEMITEM_HEAL_2NAME",
#		code = 'item_heal_2',
		description = "ITEMITEM_HEAL_2DESCRIPT",
		icon = load("res://assets/images/iconsitems/Morsel.png"),
		itemtype = 'usable_combat',
	...
	item_heal_3 = {
		name = "ITEMITEM_HEAL_3NAME",
#		code = 'item_heal_3',
		description = "ITEMITEM_HEAL_3DESCRIPT",
	...
	item_heal_aoe_1 = {
		name = "ITEMITEM_HEAL_AOE_1NAME",
#		code = 'item_heal_aoe_1',
		description = "ITEMITEM_HEAL_AOE_1DESCRIPT",
	...
	item_heal_aoe_2 = {
		name = "ITEMITEM_HEAL_AOE_2NAME",
#		code = 'item_heal_aoe_2',
		description = "ITEMITEM_HEAL_AOE_2DESCRIPT",
	...
	item_heal_aoe_3 = {
		name = "ITEMITEM_HEAL_AOE_3NAME",
#		code = 'item_heal_aoe_3',
		description = "ITEMITEM_HEAL_AOE_3DESCRIPT",
	...
	item_dispel_1 = {
		name = "ITEMITEM_DISPEL_1NAME",
#		code = 'item_dispel_1',
		description = "ITEMITEM_DISPEL_1DESCRIPT",
	...
	item_dispel_2 = {
		name = "ITEMITEM_DISPEL_2NAME",
#		code = 'item_3_2',
		description = "ITEMITEM_DISPEL_2DESCRIPT",
	...
	item_res_1 = {
		name = "ITEMITEM_RES_1NAME",
#		code = 'item_res_1',
		description = "ITEMITEM_RES_1DESCRIPT",
	...
	item_res_2 = {
		name = "ITEMITEM_RES_2NAME",
#		code = 'item_res_2',
		description = "ITEMITEM_RES_2DESCRIPT",
	...
	item_res_3 = {
		name = "ITEMITEM_RES_3NAME",
#		code = 'item_res_3',
		description = "ITEMITEM_RES_3DESCRIPT",
	...
	item_res_4 = {
		name = "ITEMITEM_RES_4NAME",
#		code = 'item_res_4',
		description = "ITEMITEM_RES_4DESCRIPT",
	...
	item_barrier_1 = {
		name = "ITEMITEM_BARRIER_1NAME",
#		code = 'item_barrier_1',
		description = "ITEMITEM_BARRIER_1DESCRIPT",
	...
	item_barrier_2 = {
		name = "ITEMITEM_BARRIER_2NAME",
#		code = 'item_barrier_2',
		description = "ITEMITEM_BARRIER_2DESCRIPT",
	...
	item_barrier_3 = {
		name = "ITEMITEM_BARRIER_3NAME",
#		code = 'item_barrier_3',
		description = "ITEMITEM_BARRIER_3DESCRIPT",
	...
	item_damage_1 = {
		name = "ITEMITEM_DAMAGE_1NAME",
#		code = 'item_damage_1',
		description = "ITEMITEM_DAMAGE_1DESCRIPT",
	...
	item_damage_2 = {
		name = "ITEMITEM_DAMAGE_2NAME",
#		code = 'item_damage_2',
		description = "ITEMITEM_DAMAGE_2DESCRIPT",
	...
	item_buff_atk = {
		name = "ITEMITEM_BUFF_ATKNAME",
#		code = 'item_buff_atk',
		description = "ITEMITEM_BUFF_ATKDESCRIPT",
	...
	item_buff_def = {
		name = "ITEMITEM_BUFF_DEFNAME",
#		code = 'item_buff_def',
		description = "ITEMITEM_BUFF_DEFDESCRIPT",
...
var gold_info = {name = "GOLD",
	code = 'gold',
	description = "GOLDDESCRIPT",
